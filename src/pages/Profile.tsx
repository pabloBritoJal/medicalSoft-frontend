          ...
          <div className="mt-4">
            <div className="flex-1">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
                <ProfileDetail title="Número de Licencia" value="123456789" />
                <ProfileDetail title="Teléfono" value="+1 234 567 890" />
                <ProfileDetail
                  title="Consultorio"
                ...
                <ProfileDetail
                  ...
                  value="Lun-Vie: 9:00 AM - 5:00 PM"
                />
                <ProfileDetail title="Idiomas" value="Español, Inglés" />
                <ProfileDetail title="Años de Experiencia" value="10 años" />
              </div>
            </div>
...
const ProfileDetail = ({ title, value }: { title: string; value: string }) => (
  <div className="rounded-lg border border-stroke bg-gray-100 p-4 text-center dark:border-strokedark dark:bg-gray-800">
